...
WHITELIST="skill_workshop defaults excluded skills depends_on old-name skill-improvement openclaw skill-creator spike _builtin_plugin_skills skill_later skill_earlier1 skill_earlier2 main master dev" # main/master/dev — git-ветки, ложные позитивы правила (b)
