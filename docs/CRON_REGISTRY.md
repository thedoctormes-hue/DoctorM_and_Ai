...
- **Действия при сбое:** проверить /root/LabDoctorM/.qwen/scripts/artifact_refresh.sh

### factcheck_all_daily
- **Расписание:** ежедневно 02:00 UTC
- **Статус:** ✅ ok (225s)
- **Назначение:** ежедневная проверка фактов артефактов
- **Действия при сбое:** проверить /root/LabDoctorM/.qwen/scripts/factcheck_all.sh
...
### Qwen Archive Cleanup Check
- **Расписание:** 24.06.2026 12:00 UTC (одноразовое)
- **Статус:** idle
- **Назначение:** напоминание проверить актуальность архива Qwen
