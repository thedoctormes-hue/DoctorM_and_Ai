...
**Запрещено:**
- Создавать папки/файлы в корне `/root/LabDoctorM/`
- Складывать артефакты в произвольные места

**Правильно:**
- Артефакты проекта → `/root/LabDoctorM/projects/<проект>/`
- Рабочие файлы агента → `/root/LabDoctorM/workspaces/<агент>/`
- Инфраструктура → `/root/LabDoctorM/projects/DoctorM_and_Ai/`
- Операционка → `/root/LabDoctorM/.ops/`

При неясности — спроси ЗавЛаба.
